...
API_ID = int(getenv("API_ID", "21618095"))
API_HASH = getenv("API_HASH", "43482b3987d30ae122c2213c497986a8")

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("BOT_TOKEN", "8047982460:AAEvlkrwhtguH3INN6N2IlEoIoDzp7xdMlk")
...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME","𝐀𝐥𝐢𝐬𝐚 𝐱 𝐦𝐮𝐬𝐢𝐜")
PRIVATE_BOT_MODE = getenv("PRIVATE_BOT_MODE", None)

DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 900))

# Chat id of a group for logging bot's activities
LOGGER_ID = int(getenv("LOGGER_ID","1002389272474" ))
...
HEROKU_APP_NAME = getenv("prince  kumar")
# Get it from http://dashboard.heroku.com/account
HEROKU_API_KEY = getenv("HRKU-8827b3f5-813b-4c56-8dd3-175e75b1a406")
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Revengers_chat_Group")
...
STRING1 = getenv("BQFJ3a8AY9lmsJo4HPY43Vt11f0wWXynsIcocKLMaNH8jKv2piw3ama9xTI1zPGnCw2AJtRZrRNvipfCVx8VXnD9j9vHpNfS4fivY8DXeTt5Ce3UDh95Nr2-x34M37-y93kEtQ1IKX1xNWQkZ2_6SdHuzTkdaxNg-UlQnfIxOcbIsRWlGbR8A2kIb0FiGskPLjxG0q_tXbGtOMLKX-jGg6kCL751PwaJreVJ9yReqWg8_t9lgSnL1LkJT4Psi5593nrQiJALYP658UQPnzbbLTTdZoig49X1MHUDK4ofQo2OHkcTxuqZXvgcSb_IWc6G5S70dHHguD6T27ZDS0L7ANF_Jg1g_wAAAAGP4Lp9AA",)
...
START_IMG_URL = getenv(
    "https://unitedcamps.in/Images/IMG_1742795844.jpg"
)
PING_IMG_URL = getenv(
